  ...
  return knex('logs').del()
    .then(function () {
      ...
      return knex('logs').insert([
        { "edit_code":"4n8", "name": "Susan", "content": "galvanize andrew coffee ibm susan andrew glasses french press grinder"},
        ...
        { "edit_code":"uvw", "name": "Mariya", "content": "andrew missed connection q2 galvanize glasses 35 analytical tattoos app chores dog walker"},
        { "edit_code":"rob", "name": "Adam", "content": "cortado instructor galvanize andrew q2 missed connections"},
